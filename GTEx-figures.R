...
gtex_kidney=subset(df_gtex, df_gtex$primary_site == 'Kidney')
...
gtex_cervix=subset(df_gtex, df_gtex$primary_site == 'Cervix Uteri')
...
gtex_lung=subset(df_gtex, df_gtex$primary_site == 'Lung')
...
gtex_skin=subset(df_gtex, df_gtex$primary_site == 'Skin')
...
gtex_pancreas=subset(df_gtex, df_gtex$primary_site == 'Pancreas')
...
gtex_colon=subset(df_gtex, df_gtex$primary_site == 'Colon')
...
gtex_thyroid=subset(df_gtex, df_gtex$primary_site == 'Thyroid')
...
gtex_uterus=subset(df_gtex, df_gtex$primary_site == 'Uterus')
...
gtex_bladder=subset(df_gtex, df_gtex$primary_site == 'Bladder')
...
gtex_stomach=subset(df_gtex, df_gtex$primary_site == 'Stomach')
...
gtex_nerve=subset(df_gtex, df_gtex$primary_site == 'Nerve')
...
gtex_liver=subset(df_gtex, df_gtex$primary_site == 'Liver')
...
gtex_breast=subset(df_gtex, df_gtex$primary_site == 'Breast')
...
gtex_esophagus=subset(df_gtex, df_gtex$primary_site == 'Esophagus')
...
gtex_brain=subset(df_gtex, df_gtex$primary_site == 'Brain')
...
gtex_prostate=subset(df_gtex, df_gtex$primary_site == 'Prostate')
